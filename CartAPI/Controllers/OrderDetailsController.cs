...
namespace CartAPI.Controllers
{
    ...
    public class OrderDetailsController : ControllerBase
    {
        ...
        public OrderDetailsController(ProductRentalContext context)
        {
            _context = context;
        }
        ...
        {
            List<OrderDetail> orderDetail = await (from i in _context.OrderDetails where i.UserId == id select i).ToListAsync();
